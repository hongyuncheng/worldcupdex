  ...
  <div class="share-panel">
    ...
    <div class="share-panel__section">
      ...
      <div class="share-panel__grid">
        <!-- Twitter / X -->
        <button class="share-panel__btn" @click="shareTwitter">
          ...
          <span class="share-panel__label">Twitter / X</span>
        </button>
        <!-- Instagram -->
        <button class="share-panel__btn" @click="shareInstagram">
        ...
        <!-- Discord -->
        <button class="share-panel__btn" @click="shareDiscord">
        ...
        <!-- WhatsApp -->
        <button class="share-panel__btn" @click="shareWhatsApp">
        ...
        <!-- Reddit -->
        <button class="share-panel__btn" @click="shareReddit">
        ...
        <!-- Copy Link -->
        <button class="share-panel__btn" @click="handleCopyLink">
